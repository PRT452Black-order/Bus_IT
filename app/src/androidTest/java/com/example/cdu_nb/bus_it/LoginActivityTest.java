...
public class LoginActivityTest {
    ...
    public void loginActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.etLoginUsername),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.etLoginUsername), withText("test"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.etLoginUsername), withText("test@test.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        try {
            Thread.sleep(3494300);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        //check that bus page shows after login
